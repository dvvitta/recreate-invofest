 ...
 <section
    ...
    >
      <div className="w-2/3 flex flex-col gap-6">
        ...
        <h2 className="text-4xl text-red-800 font-semibold">
...
<section className="px-6 lg:px-12 max-w-6xl mx-auto">
        <h2 className="text-red-900 text-4xl font-bold mb-12 text-center uppercase tracking-widest">
 ...
 const pelaksanaanList = [
    { title: "Mobile Development", date: "Selasa, 25 November 2025", time: "08.00 WIB - 16.30 WIB", location: "Lab Kom D.1", icon: Code },
    { title: "Artificial Intelligence", date: "Selasa, 25 November 2025", time: "08.00 WIB - 16.30 WIB", location: "Lab Kom D.2", icon: Cpu },
    { title: "Cyber Security", date: "Rabu, 26 November 2025", time: "08.00 WIB - 16.30 WIB", location: "Lab Kom D.1", icon: ShieldCheck },
  ];
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto"></div>
