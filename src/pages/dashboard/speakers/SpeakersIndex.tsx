...
import { useGetSpeakers, useDeleteSpeaker } from "../../../Hooks/useSpeakers";
...
export default function SpeakerIndex() {
  ...
  const handleDelete = (id: number, name: string) => {
    if (
      window.confirm(`Apakah kamu yakin ingin menghapus pembicara "${name}"?`)
    ) {
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Manage your event speakers here
          </p>
        </div>
        <Link
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right space-x-3">
                    ...
                    >
                      ...
                      deleteSpeakerMutation.variables === speaker.id
                        ? "Deleting..."
                        : "Delete"}
                    </button>
                  </td>
